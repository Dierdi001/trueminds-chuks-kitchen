...
export default function WelcomeLayout({
    ...
    return (
        <div className="flex min-h-screen flex-col">
            {/* Image mobile en haut (visible seulement sur mobile) */}
            <motion.div 
                initial={{ opacity: 0, y: -20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6 }}
                className="lg:hidden w-full h-64 p-4"
            >
                <img 
                    src="/images/auth-mobile.png" 
                    alt="Authentication Mobile" 
                    className="h-full w-full object-cover"
                />
            </motion.div>

            <div className="flex flex-1 flex-col lg:flex-row">
                {/* Partie gauche - Image desktop (cachée sur mobile) */}
                <motion.div 
            ...
            {/* Footer - Version Chuks Kitchen */}
            <motion.footer 
                initial={{ opacity: 0, y: 50 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.4 }}
                className="bg-[#62412e] px-6 py-12 md:px-12 lg:px-24"
            >
